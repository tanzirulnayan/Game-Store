            ...
            <div class="col-lg-5 col-md-6 offset-lg-0 offset-md-3">
              ...
              <div class="card card-register">
                <div class="card-header">
                  ...
                  <h4 class="card-title" style="color:white;">Moderator</h4>
                </div>
                <div class="card-body">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="MOD_NAME" placeholder="Full Name">
                    </div>
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="MOD_EMAIL" placeholder="Email">
                    </div>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="MOD_ADDRESS" placeholder="Address" >
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" name="MOD_DOB" placeholder="Date of Birth">
                      </div>
